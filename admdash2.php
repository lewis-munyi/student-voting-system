      ...
      ?>
        ...
        <tbody>
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    $sql2 = "SELECT * FROM registeredStudents WHERE studentRegistration = '$sender'";
                                    $lewis = mysql_query($connection , $sql2);
                                    if ($lewis) {
                                        echo "Munyi";
                                    } else {
                                        # code...
                                    ...
                                    $sen = mysqli_fetch_array($lewis);
                                    $sender_real = $sen['first_name'] . " " . $sen['second_name'];
                                    echo "<tr><td class= 'center'>". $sender_real . "</td><td class='center'>". $row['message'] ."</td></tr>";
